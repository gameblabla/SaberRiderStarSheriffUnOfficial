...
/* animation table changes: April's sheet has a 6-frame idle sway followed by a 21-frame stretch + wave (her clip
 * runs at 10 fps), 7 run frames, 8 death frames and a 23-frame "gun sling into idle" that plays as the alert pose
 * (anims 4/7, held for alert_time after shooting / landing) */
...
static const AnimPatch APRIL_ANIMS[] = {
    ...
    { APRIL_BORED_L, 232, 252, 252, 0.10f }, { APRIL_BORED_R, 256, 276, 276, 0.10f },   /* bored stretch + wave L / R */
    ...
    { 4, 184, 206, 206, 0.07f }, { 7, 208, 230, 230, 0.07f },     /* gun sling into idle L / R (alert) */
    { 52, 168, 168, 168, 4.0f },
};
