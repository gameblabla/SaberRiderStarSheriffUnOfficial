...
void music_set_volume(real v);                 /* FUN_00425e70: 0..1 fade factor on top of the track's own volume */
void music_set_duck(real v);                   /* temporary power-attack music level; ramps without stopping playback */
