...
int  aud_play(AudSample *s, real gain, bool loop) { (void)s; (void)gain; (void)loop; return -1; }
void aud_set_gain(int voice, real gain) { (void)voice; (void)gain; }
...
void aud_music_gain(real g) { (void)g; }
